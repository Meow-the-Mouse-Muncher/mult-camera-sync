...
class AsyncFlirThermalController:
    ...
    def __init__(self, save_path):
        ...
        self.executor = ThreadPoolExecutor(max_workers=6)  # 使用6个线程（与三相机版本保持一致）
    ...
    def start_capture(self):
        ...
        for i, cam in enumerate(self.flir.cam_list):
            ...
            try:
                ...
                # 等待采集完成
                self.capture_complete_event.wait(timeout=20)  # 与三相机版本保持一致的50秒超时
    ...
    def _flir_capture_worker(self, cam, nodemap):
        ...
        try:
            ...
            # 不在这里设置ACQUISITION_FLAG，让_mark_camera_complete统一处理
            # ACQUISITION_FLAG.value = 1  # ← 删除这行
    ...
    def _mark_camera_complete(self):
        ...
        with self.status_lock:
            ...
            print(f"相机完成采集进度: {self.completed_cameras}/2")  # 改为2个相机
    ...
    def cleanup(self):
        ...
        try:
            ...
            if self.thermal_cam:
                try:
                    print("强制停止红外相机采集...")
                    self.thermal_cam.is_capturing = False
                    time.sleep(0.5)  # 等待停止
